...
This issue tracker is only for technical issues related to Praxis Core.
General Praxis questions and/or support requests and are best directed to the [Praxis Discord](https://discord.praxis.org).
...
### What version of Praxis Core are you using?
