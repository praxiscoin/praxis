...
The Praxis Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Praxis Core project, and is not to be
confused with overall Praxis Network Protocol consensus changes.

Whether a pull request is merged into Praxis Core rests with the project merge
...
Patches that change Praxis consensus rules are considerably more involved than
...
Where a patch set proposes to change the Praxis consensus, it must have been
...
The project leader is the release manager for each Praxis Core release.
