...
In order to support loading of multiple wallets in praxis-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is praxis.cpp.
...
Changes to praxis.cpp
----------------------
praxis.cpp is the entry point into praxis-qt, and as such, will require some minor modifications to provide hooks for
