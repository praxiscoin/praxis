...
RESOURCES += src/qt/praxis.qrc src/qt/praxis_locale.qrc

TRANSLATIONS += src/qt/locale/praxis_bg.ts \
                src/qt/locale/praxis_de.ts \
                src/qt/locale/praxis_en.ts \
                src/qt/locale/praxis_es.ts \
                src/qt/locale/praxis_fi.ts \
                src/qt/locale/praxis_fr.ts \
                src/qt/locale/praxis_it.ts \
                src/qt/locale/praxis_ja.ts \
                src/qt/locale/praxis_pl.ts \
                src/qt/locale/praxis_pt.ts \
                src/qt/locale/praxis_ru.ts \
                src/qt/locale/praxis_sk.ts \
                src/qt/locale/praxis_sv.ts \
                src/qt/locale/praxis_vi.ts \
                src/qt/locale/praxis_zh_CN.ts \
                src/qt/locale/praxis_zh_TW.ts
