...
#   c) node1 mines 32 blocks, so now node 0 has 60001pxc, node 1 has 4250pxc, node2 has none.
#   d) node0 sends 601 pxc to node2, in two transactions (301 pxc, then 300 pxc).
