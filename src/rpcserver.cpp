...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Praxis features */
        {"praxis", "masternode", &masternode, true, true, false},
        {"praxis", "listmasternodes", &listmasternodes, true, true, false},
        {"praxis", "getmasternodecount", &getmasternodecount, true, true, false},
        {"praxis", "masternodeconnect", &masternodeconnect, true, true, false},
        {"praxis", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"praxis", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"praxis", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"praxis", "masternodecurrent", &masternodecurrent, true, true, false},
        {"praxis", "masternodedebug", &masternodedebug, true, true, false},
        {"praxis", "startmasternode", &startmasternode, true, true, false},
        {"praxis", "createmasternodekey", &createmasternodekey, true, true, false},
        {"praxis", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"praxis", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"praxis", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"praxis", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"praxis", "getmasternodescores", &getmasternodescores, true, true, false},
        {"praxis", "mnbudget", &mnbudget, true, true, false},
        {"praxis", "preparebudget", &preparebudget, true, true, false},
        {"praxis", "submitbudget", &submitbudget, true, true, false},
        {"praxis", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"praxis", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"praxis", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"praxis", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"praxis", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"praxis", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"praxis", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"praxis", "checkbudgets", &checkbudgets, true, true, false},
        {"praxis", "mnsync", &mnsync, true, true, false},
        {"praxis", "spork", &spork, true, true, false},
        {"praxis", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzpxcseed", &getzpxcseed, false, false, true},
        {"zerocoin", "setzpxcseed", &setzpxcseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzpxc", &searchdzpxc, false, false, true},
        {"zerocoin", "dzpxcstate", &dzpxcstate, false, false, true}
...
{
    return "> praxis-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:8655/\n";
}
