...
extern UniValue setzpxcseed(const UniValue& params, bool fHelp);
extern UniValue getzpxcseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzpxc(const UniValue& params, bool fHelp);
extern UniValue dzpxcstate(const UniValue& params, bool fHelp);
