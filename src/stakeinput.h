...
#ifndef Praxis_STAKEINPUT_H
#define Praxis_STAKEINPUT_H
...
public:
    ...
    virtual bool IsZPXC() = 0;
    virtual CDataStream GetUniqueness() = 0;
};


// zPXCStake can take two forms
// 1) the stake candidate, which is a zcmint that is attempted to be staked
// 2) a staked zpxc, which is a zcspend that has successfully staked
...
public:
    ...
    bool IsZPXC() override { return true; }
...
public:
    ...
    bool CreateTxIn(CWallet* pwallet, CTxIn& txIn, uint256 hashTxOut = 0) override;
    bool CreateTxOuts(CWallet* pwallet, vector<CTxOut>& vout, CAmount nTotal) override;
    bool IsZPXC() override { return false; }
};


#endif //Praxis_STAKEINPUT_H
