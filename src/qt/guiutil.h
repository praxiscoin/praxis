...
/** Utility functions used by the Praxis Qt UI.
 */
namespace GUIUtil
{
...
// Render Praxis addresses in monospace font
...
// Parse "praxis:" URI into recipient object, return true on successful parsing
