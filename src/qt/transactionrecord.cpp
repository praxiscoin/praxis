...
QList<TransactionRecord> TransactionRecord::decomposeTransaction(const CWallet* wallet, const CWalletTx& wtx)
{
    ...
    if (wtx.IsCoinStake()) {
        ...
        if (wtx.IsZerocoinSpend() && (fZSpendFromMe || wallet->zpxcTracker->HasMintTx(hash))) {
            //zPXC stake reward
            sub.involvesWatchAddress = false;
            sub.type = TransactionRecord::StakeZPXC;
...
bool IsZPXCType(TransactionRecord::Type type)
{
    switch (type) {
        case TransactionRecord::StakeZPXC:
...
void TransactionRecord::updateStatus(const CWalletTx& wtx)
{
    ...
    else if (type == TransactionRecord::Generated || type == TransactionRecord::StakeMint || type == TransactionRecord::StakeZPXC || type == TransactionRecord::MNReward) {
