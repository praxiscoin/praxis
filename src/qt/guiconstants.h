...
/* Praxis GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Praxis"
#define QAPP_ORG_DOMAIN "praxis.org"
#define QAPP_APP_NAME_DEFAULT "Praxis-Qt"
#define QAPP_APP_NAME_TESTNET "Praxis-Qt-testnet"
