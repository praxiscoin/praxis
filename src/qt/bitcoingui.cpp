                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Praxis Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Praxis address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and praxis: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zPXC"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Praxis Core"), this);
    aboutAction->setStatusTip(tr("Show information about Praxis Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Praxis"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Praxis addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Praxis addresses"));
    ...
    openAction->setStatusTip(tr("Open a Praxis: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Praxis Core help message to get a list with possible Praxis command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Praxis Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Praxis network", "", count));
}
...
{
    QString strTitle = tr("Praxis Core"); // default title
