                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzPXCPathCustom = GetArg("-zpxcbackuppath", "");
    ...
    if(!strzPXCPathCustom.empty()) {
        ui->wallet_customzpxcbackuppath->setText(QString::fromStdString(strzPXCPathCustom));
        ui->wallet_customzpxcbackuppath_label->setVisible(true);
        ui->wallet_customzpxcbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzPXCPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Praxis RPC console.") + "<br>" +
