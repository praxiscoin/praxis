...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Praxis Core praxis-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  praxis-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded praxis transaction") + "\n" +
                               "  praxis-tx [options] -create [commands]   " + _("Create hex-encoded praxis transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded praxis transaction
